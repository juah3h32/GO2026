...
export const ar = {
  ...
  // =================================================
  distribuidor: {
    meta_title: "موزّع Grupo Ortiz | شريك رسمي في موريليا",
    meta_description: "كن موزعًا لشركة Grupo Ortiz، المصنّعة في موريليا، ميتشواكان منذ عام 1959. مخزون مضمون، بدون وسطاء، ولوجستيات خاصة.",
    hero: {
  ...
  // =================================================
  quienes_somos: {
    meta_title: "من نحن | Grupo Ortiz، مصنّع في موريليا منذ 1959",
    meta_description: "Grupo Ortiz: مصنّع الأكياس والخيش والحبال والتغليف المرن في موريليا، ميتشواكان منذ عام 1959. تعرّف على تاريخنا.",
    ...
    timeline: {
      ...
      events: [
        ...
        { year: "2026", title: "الحاضر",                short: "رائد صناعي",             img: "/images/tiempo/timeline-2026.webp",  description: "في عام 2026، لدينا 13 مصنعاً للإنتاج وأكثر من 3,000 موظف وطاقة إنتاجية سنوية تبلغ 220,000 طن. هذا النمو المستدام يرسّخنا كقادة في صناعة البلاستيك، مدعومين ببنية تحتية متينة وكفاءات بشرية متخصصة ورؤية استراتيجية نحو المستقبل." }
      ]
    },
...
footer: {
  ...
  impacto_social: {
    ...
    arboles: {
      ...
      title:       "نزرع",
      title_orange:"مساحات خضراء",
      desc:        "في Grupo Ortiz نؤمن بأن الالتزام البيئي يبدأ من الداخل. لهذا أطلقنا حملة المساحات الخضراء: أيام تشجير يقوم فيها فريقنا بزراعة الأشجار في المساحات المجتمعية، لنعيد للأرض جزءًا مما تمنحنا إياه.",
      img:         "/images/impacto/responsabilidad-social.jpg",
      tags: ["إعادة التشجير", "تطوع GO", "العناية بالكوكب"]
    },
  ...
  home: {
    ...
    divisiones: {
      ...
      items: [
        ...
        { title: "أكياس",          tag: "القسم 09", description: "أكياس بولي إيثيلين عالية المقاومة للتعبئة الصناعية والتجارية. متعددة الاستخدامات واقتصادية ومتوفرة بمقاسات وأشكال متعددة.",                    img: "/images/bolsas/bolsa.webp",                               color: "#c0392b", slug: "bolsas",             soon: false },
    ...
    newsletter: {
      tag:              "ابقَ على اطلاع",
      title:            "لا تفوّت",
      title_em:         "آخر أخبارنا",
      sub:              "احصل على العروض والمنتجات الجديدة والمحتوى الحصري مباشرة في بريدك الإلكتروني.",
      name_placeholder:  "اسمك",
      email_placeholder: "بريدك الإلكتروني",
      terms_pre:        "أوافق على",
      terms_link:       "إشعار الخصوصية",
      btn:              "اشترك",
      btn_sending:      "جارٍ الإرسال...",
      success_title:    "تم! أنت مشترك الآن",
      success_sub:      "سنرسل لك بريدًا إلكترونيًا عند وجود أخبار جديدة.",
      error:            "تعذّر الاشتراك. حاول مرة أخرى.",
      error_terms:      "يجب الموافقة على إشعار الخصوصية."
    }
  }
