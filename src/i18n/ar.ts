  ...
  home: {
    ...
    divisiones: {
      ...
      items: [
        ...
        { title: "أكياس",          tag: "القسم 09", description: "أكياس بولي بروبيلين عالية المقاومة للتعبئة الصناعية والتجارية. متعددة الاستخدامات واقتصادية ومتوفرة بمقاسات وأشكال متعددة.",                    img: "/carruselB.webp",                           color: "#c0392b", slug: "bolsas",             soon: false }
      ]
    },
