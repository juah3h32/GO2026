...
export const ar = {
  ...
  // =================================================
  home: {
    meta_title: "غروبو أورتيز | مصنّع البوليمرات والتعبئة والتغليف في المكسيك",
meta_description: "أكثر من 65 عامًا في تصنيع أفلام التمدد، والأكياس، والحبال، والرافيا، والشباك، والتغليف المرن. رائد في مجال البوليمرات البلاستيكية في المكسيك وأمريكا اللاتينية.",
