...
export const pt = {
  ...
  chatbot: {
    // ── Mensagens gerais ──
    greeting:            'Olá! Sou o BotGo 🤖. Como posso te ajudar hoje?',
  ...
  pwa: {
    ...
    description: "Acesso rápido a partir da sua tela inicial",
    install: "Instalar",
    notNow: "Agora não",
    timeLabel: "agora"
  },
  ...
  catalog: {
    ...
    divisions: [
      ...
      },
      {
        id: "5",
        name: "SACO",
        desc: "Polipropileno tecido plano para embalagem em massa. Resistência superior para produtos a granel.",
  ...
  stretch_film: {
    ...
    back_aria: "Voltar para produtos",
    specs_title: "ESPECIFICAÇÕES TÉCNICAS",
 ...
 arpillas: {
  ...
  bolsas: {
    ...
    meta_description: "Bolsas de polietileno de alta resistência para embalagem industrial e comercial. Disponíveis em 5 tamanhos.",
    back_aria: "Voltar a produtos",
    specs_title: "ESPECIFICAÇÕES TÉCNICAS",
    ...
    products: [
      {
        ...
        link:  "#",
        description: "Bolsa de polietileno compacta, ideal para embalagem de produtos pequenos. Perfeita para varejo, embalagem de sementes, especiarias e produtos de consumo em porções individuais. Alta resistência ao rasgamento com acabamento uniforme.",
        specs_values: { width: "15 cm", height: "25 cm", mat: "Polietileno", use: "Varejo" },
      ...
      },
      {
        ...
        link:  "#",
        description: "Bolsa de polietileno de tamanho padrão para embalagem versátil de produtos de médio volume. Ideal para grãos, cereais, lanches e artigos de uso diário com apresentação limpa e durável.",
        specs_values: { width: "18 cm", height: "25 cm", mat: "Polietileno", use: "Embalagem industrial" },
      ...
      },
      {
        ...
        specs_values: { width: "20 cm", height: "30 cm", mat: "Polietileno", use: "Embalagem agrícola" },
      ...
      },
      {
        ...
        specs_values: { width: "25 cm", height: "35 cm", mat: "Polietileno", use: "Distribuição a granel" },
      ...
      },
      {
        ...
        link:  "#",
        description: "Bolsa de polietileno de alta capacidade para embalagem de produtos de alto volume. Projetada para cargas pesadas, materiais industriais e logística de distribuição exigente. Acabamento resistente de alta qualidade.",
        specs_values: { width: "35 cm", height: "45 cm", mat: "Polietileno", use: "Embalagem industrial" },
      ...
      },
      {
        ...
        link:  "#",
        description: "Bolsa extra-grande para embalagem e armazenamento de produtos volumosos. Ideal para têxteis, materiais de construção leves e distribuição em grande escala. Resistência estrutural máxima.",
        specs_values: { width: "40 cm", height: "60 cm", mat: "Polietileno", use: "Armazenamento industrial" },
      ...
      },
      {
        ...
        link:  "#",
        description: "Bolsa de grande formato para cargas de alto peso e volume. Projetada para aplicações industriais de alta demanda, logística de exportação e armazenagem de materiais a granel. Resistência extrema garantida.",
        specs_values: { width: "50 cm", height: "70 cm", mat: "Polietileno", use: "Logística e exportação" },
      ...
      },
      {
        ...
        link:  "#",
        description: "A bolsa de maior capacidade do catálogo. Ideal para embalagem industrial em grande escala, armazenamento de insumos pesados e distribuição em massa. Construída para suportar as exigências mais extremas.",
  ...
  // =================================================
  acolchado: {
    meta_title: "Acolchoado | Grupo Ortiz",
    meta_description: "Material acolchoado de polipropileno para proteção e amortecimento industrial. Alta resistência ao impacto.",
    ...
    products: [
      {
        ...
        link:  "#",
        description: "O mulch agrícola (acolchado) é um filme plástico colocado sobre o solo para o proteger e maximizar o rendimento das culturas. Evita o crescimento de ervas daninhas e relva sem herbicidas, conserva a humidade do solo reduzindo a rega, regula a temperatura da terra, previne a erosão e a lama, e mantém o cultivo mais limpo. Ideal para cultivos hortícolas, jardins e hortas de qualquer escala.",
        specs_values: {
  ...
  distribuidor: {
    ...
    cards: [
      ...
      { icon: "ri-truck-line",        title: "Entregas em 24h", desc: "Logística própria. Seus clientes não esperam, entregamos em tempo recorde."              },
      { icon: "ri-shield-check-line", title: "Garantia",        desc: "Trocas físicas sem burocracia nem perguntas. Respaldo total de marca."                  },
    ...
    form: {
      ...
      desc: "Junte-se à rede. Preencha seu perfil para receber zona e lista de preços preferencial.",
      ...
      success_msg: "Registro concluído!"
    }
  },
  ...
  quienes_somos: {
    ...
    timeline: {
      ...
      video_poster:  "",
      events: [
        { year: "1959", title: "O Início",                  short: "Fundação em Morelia",    img: "/images/tiempo/timeline-1959.webp",  description: "Desde 1959, o Grupo Ortiz fez parte do desenvolvimento industrial do México. Fundado em Morelia por Nicandro Ortiz, o grupo nasceu com uma visão firme: combinar tecnologia de ponta com o talento e a dedicação de sua equipe para construir uma empresa sólida, inovadora e comprometida com a qualidade." },
        ...
        { year: "2005", title: "Expansão Internacional",    short: "América e Europa",       img: "/images/tiempo/timeline-2005.webp",  description: "Em 2005, iniciamos exportações para a América e a Europa, marcando um passo decisivo em nossa expansão internacional. Esta conquista posicionou a empresa como referência na indústria de polímeros plásticos, fortalecendo nossa presença global e consolidando nossa competitividade em mercados internacionais." },
        { year: "2015", title: "Sustentabilidade",          short: "Planta de reciclagem",   img: "/images/tiempo/timeline-2015.webp",  description: "Em 2015, implementamos uma planta de reciclagem e fortalecemos nossos programas de sustentabilidade, reafirmando nosso compromisso com o meio ambiente. Esta iniciativa estratégica otimizou o aproveitamento de recursos, impulsionou práticas responsáveis e consolidou nossa visão de crescimento." },
        { year: "2026", title: "Presente",                  short: "Líder industrial",       img: "/images/tiempo/timeline-2026.webp",  description: "Em 2026, contamos com 13 plantas de produção, mais de 3.000 colaboradores e uma capacidade anual de 220.000 toneladas. Este crescimento sustentado nos consolida como líderes na indústria do plástico, respaldados por uma infraestrutura sólida, talento humano especializado e uma visão estratégica orientada ao futuro." }
      ]
    },
    ...
    infraestructura: {
      ...
      stats: [
        ...
        { number: "260",    label: "Unidades Logísticas",     desc: "Frota própria que garante distribuição eficiente e entregas seguras em nível nacional e internacional.", icon: "number" },
    ...
    instalaciones: {
      ...
      subtitle:     "Visitas Virtuais 360°",
      badge_soon:   "Em breve",
      badge_tour:   "Ver visita",
      ...
      items: [
        ...
        { id: "telares",    num: "02", title: "Sacos de Rede",         tag: "Morelia, Mich.", desc: "Teares de última geração que tecem o fio para produzir tecido de polipropileno com máxima uniformidade.",                  thumb: "/images/virtual/RA.webp", link: "https://my.matterport.com/show/?m=2xCe1VajMjj&ss=1&sr=2.28,-1.47&play=1&qs=1&ts=1", soon: false },
    ...
    capacidad: {
      ...
      items: [
        ...
        { num: "01", label: "Embalagem Flexível",  width: 25,  delay: 400 },
    ...
    valores: {
      ...
      subtitle: "Os pilares de nossa cultura",
      items: [
        ...
        { title: "Confiança",        description: "Construímos relações sólidas baseadas em transparência, honestidade e cumprimento de promessas, gerando segurança em cada interação."               },
        ...
        { title: "Respeito",         description: "Valorizamos a diversidade, dignidade e contribuição de cada pessoa, promovendo um ambiente de colaboração, inclusão e tratamento igualitário."      }
      ]
    }
  },
...
footer: {
  ...
  impacto_social: {
    ...
    ods: {
      ...
      description: "Somos guiados pelos Objetivos de Desenvolvimento Sustentável da ONU para construir um mundo mais justo, próspero e sustentável.",
      cards: [
        { n: 1,  title: "Fim da Pobreza",               link: "https://sdgs.un.org/es/goals/goal1",  img: "/images/odc/1.png"  },
        ...
        { n: 6,  title: "Água Potável e Saneamento",    link: "https://sdgs.un.org/es/goals/goal6",  img: "/images/odc/6.png"  },
        { n: 7,  title: "Energia Acessível e Limpa",    link: "https://sdgs.un.org/es/goals/goal7",  img: "/images/odc/7.png"  },
        ...
        { n: 12, title: "Consumo Responsável",          link: "https://sdgs.un.org/es/goals/goal12", img: "/images/odc/12.png" },
        ...
        { n: 16, title: "Paz, Justiça e Instituições",  link: "https://sdgs.un.org/es/goals/goal16", img: "/images/odc/16.png" },
        { n: 17, title: "Parcerias e Meios de Implementação", link: "https://sdgs.un.org/es/goals/goal17", img: "/images/odc/17.png" },
      ]
    },
    ...
    arboles: {
      ...
      desc:        "Na Grupo Ortiz acreditamos que o compromisso ambiental começa em casa. Por isso lançamos a campanha Áreas Verdes: jornadas de reflorestamento onde nossa equipe planta árvores em espaços da comunidade, devolvendo à terra parte do que ela nos dá.",
      img:         "/images/impacto/responsabilidad-social.jpg",
      tags: ["Reflorestamento", "Voluntariado GO", "Cuidado com o planeta"]
    },
  ...
  home: {
    ...
    meta_description: "Mais de 65 anos fabricando stretch film, sacos, cordas, rafia, redes e embalagens flexíveis. Líder em polímeros plásticos no México e na América Latina.",
    hero: {
      eyebrow:      "Desde 1959",
    ...
    divisiones: {
      ...
      items: [
        { title: "Saco de Rede",      tag: "Divisão 01", description: "Sacos de malha de rafia de polipropileno em tecido plano e circular. Design ventilado ideal para frutas, verduras e produtos agrícolas.",                    img: "/images/divisiones/arpilla.webp",           color: "#2d8a4e", slug: "arpillas",           soon: false },
        ...
        { title: "Rafia",             tag: "Divisão 03", description: "Rafia de polipropileno de alto rendimento. Grande leveza, alta resistência à ruptura e versatilidade para agricultura, avicultura e horticultura.",          img: "/images/divisiones/rafia.webp",             color: "#8a6d2d", slug: "rafias",             soon: false },
    ...
    porque: {
      ...
      features: [
        { title: "Qualidade Certificada",  description: "Produtos que atendem aos mais altos padrões internacionais de manufatura."           },
